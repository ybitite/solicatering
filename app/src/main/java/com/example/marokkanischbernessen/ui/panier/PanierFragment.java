...
import com.example.marokkanischbernessen.databinding.FragmentPanierBinding;
import com.example.marokkanischbernessen.ripository.ConteurRipository;
import com.example.marokkanischbernessen.ui.panier.rvpanier.ArticlePanierListAdapter;
import com.example.marokkanischbernessen.ui.panier.rvpanier.ArticlePanierPiedAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        listenerSP = new SharedPreferences.OnSharedPreferenceChangeListener() {
            ...
            public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
                if (key == ConteurRipository.POINT_RESTE_KEY) articlePanierPiedAdapter.bind();
            }
        };
